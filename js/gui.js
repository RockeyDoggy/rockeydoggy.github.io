...
function guis(){
  ...
  headNome.innerHTML = "Gui";
  nick.innerHTML = "godiira";
    nick.setAttribute("onclick", "guiTwitch()");
...
function guiTwitch(){
  window.open('https://www.twitch.tv/godiira', '_blank');
}
